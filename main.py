...
folders = ['ones','twos','threes','fours','fives','sixs','sevens','eights','nines']
...
def main(argv):
    ...
    print os.getcwd()
    count = 0
    for file in os.listdir('/Users/williambowditch/Desktop/data'):
        if file in folders:
            print file
            for name in os.listdir('/Users/williambowditch/Desktop/data/'+file):
                if not name.startswith('.'):
                    if name in names:
                        continue
                    else:
                        count+=1
                        x = Image('/Users/williambowditch/Desktop/data/'+file+'/'+name)
                        database.append(x)
                        if count%500 ==0:
                            print 'working...',count
